...
sudo add-apt-repository ppa:ondrej/php && curl -sL https://deb.nodesource.com/setup_lts.x | bash - \
...
# Symfony Installer
sudo curl -1sLf 'https://dl.cloudsmith.io/public/symfony/stable/setup.deb.sh' | bash \
